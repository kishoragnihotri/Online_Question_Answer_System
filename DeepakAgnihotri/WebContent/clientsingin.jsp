...
try {
	...
	out.println("<h1>userid-: "+id+"</h1><br><h2>password-: "+password1+"</h2>");
	 PreparedStatement pstmt=con.prepareStatement("select  * from userdetails where userid=? and password=?");
...
out.println("<br><a style='color:red;font-size:20px;' href='clientdeleteaccount.html'>Do U Want To Delete  Your Profile/Account -:(///////////////////////)</a>");
